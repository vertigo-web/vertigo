...
fn test_app_state() {
    ...
    app_state.value1.set(2); // 2 _ 3

    assert_eq!(sum3_box.get(), (5, 2));

    app_state.value1.set(3); // 3 _ 3
    assert_eq!(sum3_box.get(), (6, 3));

    app_state.value2.set(4); // 3 _ 3
    assert_eq!(sum3_box.get(), (6, 3));

    app_state.value2.set(5); // 3 _ 3
    assert_eq!(sum3_box.get(), (6, 3));

    app_state.value3.set(6); // 3 _ 6
    assert_eq!(sum3_box.get(), (9, 4));

    app_state.value3.set(7); // 3 _ 7
