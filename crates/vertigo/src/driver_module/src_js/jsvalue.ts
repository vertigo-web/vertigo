...
export type JsValueType
    = { type: JsValueConst.U32, value: number, }
    | { type: JsValueConst.I32, value: number, }
    | { type: JsValueConst.U64, value: bigint, }
    | { type: JsValueConst.I64, value: bigint, }
    | { type: JsValueConst.F64, value: number, }
    | boolean
    | null
    | undefined
    | string
    | Array<JsValueType>
    | Uint8Array
    | { type: JsValueConst.Object, value: JsValueMapType }
    | { type: JsValueConst.Json, value: JsJsonType };
