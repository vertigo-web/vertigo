...
export namespace GuardJsValue {
    ...
    export const isNumber = (value: JsValueType): value is { type: JsValueConst.U32, value: number } | { type: JsValueConst.I32, value: number } => {
    ...
    export const isBigInt = (value: JsValueType): value is { type: JsValueConst.U64, value: bigint } | { type: JsValueConst.I64, value: bigint } => {
        if (typeof value === 'object' && value !== null && 'type' in value) {
