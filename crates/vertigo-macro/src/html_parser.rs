    ...
    fn generate_node_element(&mut self, pair: Pair<Rule>, is_root: bool) -> TokenStream {
        ...
        for pair in pair.into_inner() {
            ...
            match pair.as_rule() {
                ...
                Rule::on_click_async_attr => attrs.push(self.generate_expression_attr(pair, Some("on_click_async"))),
                ...
                Rule::el_normal_start => {
                    for tag_pair in pair.into_inner() {
                        ...
                        match tag_pair.as_rule() {
                            ...
                            Rule::on_click_async_attr => attrs.push(self.generate_expression_attr(tag_pair, Some("on_click_async"))),
