...
impl DriverBrowserDom {
    fn mount_node(&self, id: RealDomId) {
        self.inner.add_command(DriverDomCommand::MountNode {
            id,
        });
    }
    ...
    pub fn create_node(&self, id: RealDomId, name: &'static str) {
        ...
        self.inner.add_command(DriverDomCommand::CreateNode {
            id,
            name
        });
    }
    ...
    pub fn rename_node(&self, id: RealDomId, name: &'static str) {
        self.inner.add_command(DriverDomCommand::RenameNode {
            id,
            new_name: name
        })
    }
    ...
    pub fn remove_attr(&self, id: RealDomId, name: &'static str) {
        self.inner.add_command(DriverDomCommand::RemoveAttr {
            id,
            name
        });
    }
    ...
    pub fn remove_text(&self, id: RealDomId) {
        ...
        self.inner.add_command(DriverDomCommand::RemoveText {
            id,
        });
    }
    ...
    pub fn remove_node(&self, id: RealDomId) {
        ...
        self.inner.add_command(DriverDomCommand::RemoveNode {
            id,
        });
    }
    ...
    pub fn insert_before(&self, parent: RealDomId, child: RealDomId, ref_id: Option<RealDomId>) {
        ...
        self.inner.add_command(DriverDomCommand::InsertBefore {
            parent,
            child,
            ref_id
        });
