...
class DriverBrowserHashRouteJs {
    constructor(callback) {
...
export { DriverBrowserDomJs, DriverBrowserFetchJs, DriverBrowserHashRouteJs, DriverBrowserIntervalJs };
